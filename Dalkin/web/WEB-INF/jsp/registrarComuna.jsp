                            ...
                            <div class="col-lg-7 offset-lg-3 ">
                                ...
                                <div class="post_comment">
                                    <div class="contact_form_container">
                                        <form action="ver_comuna.htm" method="POST"> 
                                            <input type="nombre" class="contact_input contact_input_name" placeholder="Nombre Comuna" required="required"  name="comuna">                                    
                              
                                            <input type="submit" class="contact_button" value="Registrar" /> 
                                        </form>
                                    </div>
                                </div>
                            </div>
